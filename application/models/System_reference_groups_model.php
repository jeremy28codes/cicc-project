...
clASs System_reference_groups_model extends CI_Model {

    function __construct()
    {
        parent::__construct();
        $this->table = 'system_reference_groups';
    }
    ...
    public function getAll()
    {
        $query = $this->db->select('a.*
            ...
            ->from($this->table.' a')
            ->join('system_departments b', 'a.department_id = b.id', 'LEFT OUTER')
            ->join('system_divisions c', 'a.division_id = b.id', 'LEFT OUTER')
